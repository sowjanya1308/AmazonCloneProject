      ...
      <div>
        <div className='flex justify-around'>
            <div className='pl-20 pt-10 img-stick h-fit'>
                <img src={watch} alt ="img" className='mx-auto'/>
            ...
            <div className='m-10'>
                <h1 className='text-3xl font-semibold max-w-[30vw]'>Titan Quartz Multifunction White Dial Leather Strap Watch for Men</h1>
                <div className='mt-1'>
                ...
                <div className=' flex pt-4'>
                    <div>
                        <h1 className="text-3xl font-Medium">₹9145 <span></span></h1>
                        <h1 className="text-s line-through font-normal text-rose-600">MRP:₹9695</h1>
                    </div>
                    <div className='ml-10'>
